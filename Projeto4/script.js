...
function excluir(){
    ...
    .then(resposta => {
        ...
        else throw new Error ("Erro na requisiçãõ!")
    ...
    function exibirDados(dados){
        ...
        criarGafico(cidades, {... options,title: "Cidade dos usuários"}, "grafico-cidades","column")

        const estados = gerarDados(dados, ["Estado", "Qtd Usuários"], "estado")
        criarGafico(estados, {... options,title: "Estado dos usuários"}, "grafico-estados","column")
        ...
        criarGafico(emails, {... options,title: "E-mail dos usuários"}, "grafico-emails","pie")
        ...
        const idade = gerarDados(idadeUsuarios, ["Idade", "Qtd Usuários"], "idade")
        criarGafico(idade, {... options,title: "Idade dos usuários"}, "grafico-idades","pie")
    ...
    function criarGafico(dados,options, id, tipo){
